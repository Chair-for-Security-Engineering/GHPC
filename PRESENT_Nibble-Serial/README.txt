This folder contains the source code (HDL files) of the masked nibble-serial PRESENT Encryption function 

The settings should be adjusted in 'RTL/PINI_pkg.vhd' file.
